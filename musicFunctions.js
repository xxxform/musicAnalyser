...
//Координаты нот на квинтовом кругу sin(deg), cos(deg). Знак y перевернут, тк в svg верх это -1
// [[0,1], [.5,.87], [.87,.5], [1,0], [.87,-.5],[.5,-.87], [0,-1], [-.5,-.87], [-.87,-.5], [-1,0], [-.87,.5], [-.5,.87]];
//				   C        Db          D        Eb        E         F        F#         G        Ab        A        Bb         B
const notesXY = [[0,-1], [-.5,.87], [.87,-.5], [-1,0], [.87,.5], [-.5,-.87], [0,1], [.5,-.87], [-.87,.5], [1,0], [-.87,-.5], [.5,.87]]
